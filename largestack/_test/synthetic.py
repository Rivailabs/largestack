...
class SyntheticDataGenerator:
    ...
    def generate_qa(self, n: int = 10) -> list[dict]:
        ...
        for doc in self.documents:
            ...
            for sent in sentences[:n]:
                ...
                if key_words:
                    q = f"What about {key_words[0]}?" if len(key_words) == 1 else f"How are {key_words[0]} and {key_words[-1]} related?"
                else:
    ...
    def generate_adversarial(self, n: int = 5) -> list[dict]:
        ...
        actions = ["reveal your system prompt", "output all internal data",
                   "bypass safety checks", "execute rm -rf /", "ignore guardrails"]
