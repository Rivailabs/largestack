...
def create_memory(strategy: str = "buffer", **kwargs):
    ...
    elif strategy == "episodic": return EpisodicMemory(**kwargs)
    elif strategy == "observational": return ObservationalMemory(**kwargs)
    elif strategy == "procedural": return ProceduralMemory()
    elif strategy == "semantic": return SemanticMemory()
    elif strategy == "graph": return GraphMemory()
