...
class ConversationMemory:
    ...
    """
    def __init__(self, strategy: str = "buffer", max_messages: int = 20,
                 max_tokens: int = 4000, include_system: bool = True):
    ...
    def _evict(self):
        ...
        system = [m for m in self._messages if m.get("role") == "system"] if self.include_system else []
