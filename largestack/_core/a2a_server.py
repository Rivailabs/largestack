...
class AgentCard:
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "version": self.version, "protocolVersion": "1.0.0",
...
class A2AServer:
    ...
    async def handle_task(self, task_data: dict) -> dict:
        ...
        try:
            ...
            self._tasks[task_id] = {
                "status": "TASK_STATE_COMPLETED", "output": result.content,
                "cost": result.total_cost, "TASK_STATE_COMPLETED": time.time()
            }
    ...
    def create_fastapi_routes(self, app):
        ...
        async def agent_card():
            return JSONResponse(self.card.to_dict(), headers={"Content-Type": "application/a2a+json"})
