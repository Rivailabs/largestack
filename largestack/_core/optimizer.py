...
class PromptOptimizer:
    ...
    def __init__(self, metric: Callable, meta_llm: str = "openai/gpt-4o-mini",
                 max_iterations: int = 5, patience: int = 2):
        self.metric = metric
        self.meta_llm = meta_llm
        self.max_iterations = max_iterations
        self.patience = patience
    
    async def optimize(self, initial_prompt: str, examples: list,
                       eval_examples: list | None = None) -> OptimizationResult:
        ...
        meta = Agent(name="optimizer", llm=self.meta_llm,
        ...
        return OptimizationResult(
            initial_prompt=initial_prompt, best_prompt=best_prompt,
