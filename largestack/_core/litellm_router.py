...
class LiteLLMProvider:
    ...
    def supported_models(self) -> list[str]:
        ...
        return [
            ...
            "vertex_ai/gemini-2.0-flash-exp", "vertex_ai/gemini-1.5-pro",
            "bedrock/anthropic.claude-3-5-sonnet-20241022-v2:0",
            "azure/gpt-4o", "ollama/llama3.3",
            "xai/grok-2-latest", "perplexity/llama-3.1-sonar-large-128k-online",
            "cerebras/llama-3.3-70b", "mistral/mistral-large-latest",
            "cohere/command-r-plus", "replicate/meta/llama-3.3-70b-instruct",
        ]
