...
class Embedder:
    ...
    def _resolve_backend(self) -> str:
        ...
        if os.environ.get("LARGESTACK_OPENAI_API_KEY") or os.environ.get("OPENAI_API_KEY"):
            ...
            try:
                ...
                if not self.model.startswith("all-"):
                ...
                allow_mock = os.environ.get("LARGESTACK_ALLOW_MOCK_EMBEDDINGS", "").lower() in (
                    "1",
                    "true",
                    "yes",
                )
    ...
    async def embed(self, text: str) -> list[float]:
        ...
        try:
            ...
            env = os.environ.get("LARGESTACK_ENV", "development").lower()
            allow = os.environ.get("LARGESTACK_ALLOW_MOCK_EMBEDDINGS", "").lower() in (
                "1",
                "true",
                "yes",
            )
