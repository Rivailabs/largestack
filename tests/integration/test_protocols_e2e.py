...
class TestA2AAgentCard:
    ...
    def test_agent_card_default_shape(self):
        ...
        for k in ("name", "description", "version", "url", "capabilities",
                  "authentication", "defaultInputModes", "defaultOutputModes",
                  "skills"):
...
class TestA2AFastAPIServer:
    ...
    def test_well_known_agent_card_endpoint(self):
        ...
        s = A2AServer(name="my-agent", description="d", version="1.0",
...
class TestAGUIEvents:
    ...
    def test_tool_call_lifecycle_events(self):
        ...
        s = ToolCallStart(tool_call_id="tc1", tool_call_name="search",
...
def test_both_protocols_coexist():
    ...
    expected = {
        "asdict", "dataclass", "field", "Enum", "asyncio",
        "json", "logging", "time", "uuid", "Any", "AsyncIterator",
        "Callable", "annotations", "log", "create_fastapi_app",
    }
