...
def test_redacting_span_processor_is_subclass_of_spanprocessor():
    ...
    class FakeInner:
        def on_start(self, span, ctx=None): pass
...
def test_redacting_span_processor_forwards_on_ending_to_inner():
    ...
    class FakeInner:
        ...
        def shutdown(self): pass
        def force_flush(self, t=30000): return True
        def _on_ending(self, span): calls.append("on_ending")
...
def test_redacting_span_processor_swallows_inner_on_ending_errors():
    ...
    class FakeInner:
        def on_start(self, s, c=None): pass
        def on_end(self, s): pass
        def shutdown(self): pass
        def force_flush(self, t=30000): return True
        def _on_ending(self, s): raise RuntimeError("boom")
